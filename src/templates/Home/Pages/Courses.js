...
import { getCateCoursesAction, getCoursesAction } from "../../../redux/actions/coursesActions";
    ...
    <Fragment>
       <div className="courses--header w-full">
        ...
        <p className="mb-5"><BreadCrumb/></p>
          <h1 className="text-4xl uppercase">Courses</h1>
        </div>
      </div>
      <div className="courses--body mt-24">
