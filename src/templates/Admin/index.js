...
export default function Admin() {
  const data = [
    {
      ...
      maDanhMuc: "MC",
      tenDanhMuc: "Món chiên",
    },
    {
      maMonAn: "MA02",
      tenMonAn: "Cơm chiên cá mặn",
      gia: 300000,
    ...
    {
      maMonAn: "MA03",
      tenMonAn: "Gà nướng muối ớt",
      gia: 220000,
      hinhAnh: "http://casestudy.cyberlearn.vn/img/MA03.jpeg",
      maDanhMuc: "MN",
      tenDanhMuc: "Món nướng",
    },
    {
      maMonAn: "MA04",
      tenMonAn: "Gà nướng muối tiêu chanh",
      gia: 200000,
  ...
  return (
    <div>
      <div className="adminpanel grid grid-cols-5 p-3 space-y-2 ">
            ...
            <div className="divide-y divide-coolGray-700">
              <ul className="pt-2 pb-4 space-y-1 text-sm">
                {mangDanhMuc.map((danhMuc, index) => {
                  const classNameActive = ['flex', 'items-center', 'p-2', 'space-x-3', 'rounded-md', 
        ...
        <div className="flex items-start justify-start col-span-4 p-3 ">
                    ...
                    return (
                      <div key={index} className="p-4 lg:w-1/3">
                        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                          ...
                          <p className="text-red-600 text-xl inline-flex items-center">
                          ...
                          <div className="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
                            <a 
                            onClick={()=>{setOpenModal(true); setItem(item);}}
                            className="cursor-pointer text-red-600 mr-3 inline-flex items-center leading-none text-sm pr-3 py-1 border-r-2">
                              <svg
